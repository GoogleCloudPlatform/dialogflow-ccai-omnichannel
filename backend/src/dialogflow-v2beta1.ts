...
export class DialogflowV2Beta1Stream extends DialogflowV2Beta1  {
    ...
    startPipeline(): any {
        if (!this.isReady) {
          ...
          // TODO I will have to debug from here
    ...
    // Steps for CX:
    // TODO Event & Stream imports
    // TODO extend from EventEmmitter
    // Make projectId etc Public
    // New Class
    // Add to exports
}
...
function createDetectStream(isFirst, sessionPath, sessionClient) {
  ...
  const initialStreamRequest = {
    ...
    outputAudioConfig: {
      audioEncoding: 'OUTPUT_AUDIO_ENCODING_LINEAR_16', // TODO
    },
  };
