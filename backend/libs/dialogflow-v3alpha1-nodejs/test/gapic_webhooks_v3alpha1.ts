...
describe('v3alpha1.WebhooksClient', () => {
    it('has servicePath', () => {
        const servicePath = webhooksModule.v3alpha1.WebhooksClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = webhooksModule.v3alpha1.WebhooksClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = webhooksModule.v3alpha1.WebhooksClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new webhooksModule.v3alpha1.WebhooksClient();
        assert(client);
    });
    ...
    describe('getWebhook', () => {
        it('invokes getWebhook without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.GetWebhookRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Webhook());
            client.innerApiCalls.getWebhook = stubSimpleCall(expectedResponse);
            const [response] = await client.getWebhook(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getWebhook as SinonStub)
        ...
        it('invokes getWebhook without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getWebhook(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IWebhook|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createWebhook', () => {
        it('invokes createWebhook without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.CreateWebhookRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createWebhook as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateWebhook', () => {
        it('invokes updateWebhook without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.UpdateWebhookRequest());
            request.webhook = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateWebhook as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteWebhook', () => {
        it('invokes deleteWebhook without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DeleteWebhookRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteWebhook as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listWebhooks', () => {
        it('invokes listWebhooks without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ListWebhooksRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Webhook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Webhook()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Webhook()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listWebhooks as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listWebhooksStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v3alpha1.Webhook[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.Webhook) => {
        ...
        it('uses async iteration with listWebhooks without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v3alpha1.IWebhook[] = [];
