...
describe('v3alpha1.SessionsClient', () => {
    it('has servicePath', () => {
        const servicePath = sessionsModule.v3alpha1.SessionsClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sessionsModule.v3alpha1.SessionsClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sessionsModule.v3alpha1.SessionsClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sessionsModule.v3alpha1.SessionsClient();
        assert(client);
    });
    ...
    describe('detectIntent', () => {
        it('invokes detectIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DetectIntentRequest());
            request.session = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DetectIntentResponse());
        ...
        it('invokes detectIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.detectIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IDetectIntentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('matchIntent', () => {
        it('invokes matchIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.MatchIntentRequest());
            request.session = '';
            const expectedHeaderRequestParams = "session=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.MatchIntentResponse());
            client.innerApiCalls.matchIntent = stubSimpleCall(expectedResponse);
            const [response] = await client.matchIntent(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.matchIntent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes matchIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.matchIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IMatchIntentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('fulfillIntent', () => {
        it('invokes fulfillIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.FulfillIntentRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.FulfillIntentResponse());
            client.innerApiCalls.fulfillIntent = stubSimpleCall(expectedResponse);
            const [response] = await client.fulfillIntent(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.fulfillIntent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes fulfillIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.fulfillIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('streamingDetectIntent', () => {
        it('invokes streamingDetectIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.StreamingDetectIntentRequest());
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.StreamingDetectIntentResponse());
            ...
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.StreamingDetectIntentResponse) => {
                    resolve(response);
                });
        ...
        it('invokes streamingDetectIntent with error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.StreamingDetectIntentRequest());const expectedError = new Error('expected');
