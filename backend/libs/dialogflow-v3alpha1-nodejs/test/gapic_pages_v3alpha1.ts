...
describe('v3alpha1.PagesClient', () => {
    it('has servicePath', () => {
        const servicePath = pagesModule.v3alpha1.PagesClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = pagesModule.v3alpha1.PagesClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = pagesModule.v3alpha1.PagesClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new pagesModule.v3alpha1.PagesClient();
        assert(client);
    });
    ...
    describe('getPage', () => {
        it('invokes getPage without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.GetPageRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Page());
        ...
        it('invokes getPage without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getPage(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IPage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createPage', () => {
        it('invokes createPage without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.CreatePageRequest());
            request.parent = '';
    ...
    describe('updatePage', () => {
        it('invokes updatePage without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.UpdatePageRequest());
            request.page = {};
            request.page.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updatePage as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deletePage', () => {
        it('invokes deletePage without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DeletePageRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listPages', () => {
        it('invokes listPages without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ListPagesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Page()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Page()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Page()),
            ];
        ...
        it('invokes listPagesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v3alpha1.Page[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.Page) => {
        ...
        it('uses async iteration with listPages without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v3alpha1.IPage[] = [];
