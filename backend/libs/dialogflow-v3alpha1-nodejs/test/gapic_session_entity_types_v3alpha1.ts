...
describe('v3alpha1.SessionEntityTypesClient', () => {
    it('has servicePath', () => {
        const servicePath = sessionentitytypesModule.v3alpha1.SessionEntityTypesClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = sessionentitytypesModule.v3alpha1.SessionEntityTypesClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = sessionentitytypesModule.v3alpha1.SessionEntityTypesClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new sessionentitytypesModule.v3alpha1.SessionEntityTypesClient();
        assert(client);
    });
    ...
    describe('getSessionEntityType', () => {
        it('invokes getSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.GetSessionEntityTypeRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.SessionEntityType());
        ...
        it('invokes getSessionEntityType without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSessionEntityType(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.ISessionEntityType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createSessionEntityType', () => {
        it('invokes createSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.CreateSessionEntityTypeRequest());
            request.parent = '';
    ...
    describe('updateSessionEntityType', () => {
        it('invokes updateSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.UpdateSessionEntityTypeRequest());
    ...
    describe('deleteSessionEntityType', () => {
        it('invokes deleteSessionEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DeleteSessionEntityTypeRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listSessionEntityTypes', () => {
        it('invokes listSessionEntityTypes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ListSessionEntityTypesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.SessionEntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.SessionEntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.SessionEntityType()),
            ];
        ...
        it('invokes listSessionEntityTypesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v3alpha1.SessionEntityType[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.SessionEntityType) => {
        ...
        it('uses async iteration with listSessionEntityTypes without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v3alpha1.ISessionEntityType[] = [];
