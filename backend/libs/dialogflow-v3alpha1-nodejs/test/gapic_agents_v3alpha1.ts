...
describe('v3alpha1.AgentsClient', () => {
    it('has servicePath', () => {
        const servicePath = agentsModule.v3alpha1.AgentsClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = agentsModule.v3alpha1.AgentsClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = agentsModule.v3alpha1.AgentsClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new agentsModule.v3alpha1.AgentsClient();
        assert(client);
    });
    ...
    describe('getAgent', () => {
        it('invokes getAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.GetAgentRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Agent());
        ...
        it('invokes getAgent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getAgent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IAgent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createAgent', () => {
        it('invokes createAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.CreateAgentRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createAgent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateAgent', () => {
        it('invokes updateAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.UpdateAgentRequest());
            request.agent = {};
            request.agent.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAgent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteAgent', () => {
        it('invokes deleteAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DeleteAgentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('exportAgent', () => {
        it('invokes exportAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ExportAgentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes exportAgent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportAgent(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.dialogflow.v3alpha1.IExportAgentResponse, protos.google.protobuf.IStruct>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.dialogflow.v3alpha1.IExportAgentResponse, protos.google.protobuf.IStruct>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportAgent as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('restoreAgent', () => {
        it('invokes restoreAgent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.RestoreAgentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listAgents', () => {
        it('invokes listAgents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ListAgentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Agent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Agent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Agent()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAgents as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listAgentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v3alpha1.Agent[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.Agent) => {
        ...
        it('uses async iteration with listAgents without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v3alpha1.IAgent[] = [];
