...
describe('v3alpha1.IntentsClient', () => {
    it('has servicePath', () => {
        const servicePath = intentsModule.v3alpha1.IntentsClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = intentsModule.v3alpha1.IntentsClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = intentsModule.v3alpha1.IntentsClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new intentsModule.v3alpha1.IntentsClient();
        assert(client);
    });
    ...
    describe('getIntent', () => {
        it('invokes getIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.GetIntentRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Intent());
        ...
        it('invokes getIntent without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getIntent(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IIntent|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createIntent', () => {
        it('invokes createIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.CreateIntentRequest());
            request.parent = '';
    ...
    describe('updateIntent', () => {
        it('invokes updateIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.UpdateIntentRequest());
            request.intent = {};
            request.intent.name = '';
    ...
    describe('deleteIntent', () => {
        it('invokes deleteIntent without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DeleteIntentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listIntents', () => {
        it('invokes listIntents without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ListIntentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Intent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Intent()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Intent()),
            ];
        ...
        it('invokes listIntentsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v3alpha1.Intent[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.Intent) => {
        ...
        it('uses async iteration with listIntents without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v3alpha1.IIntent[] = [];
