...
describe('v3alpha1.FlowsClient', () => {
    it('has servicePath', () => {
        const servicePath = flowsModule.v3alpha1.FlowsClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = flowsModule.v3alpha1.FlowsClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = flowsModule.v3alpha1.FlowsClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new flowsModule.v3alpha1.FlowsClient();
        assert(client);
    });
    ...
    describe('createFlow', () => {
        it('invokes createFlow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.CreateFlowRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Flow());
            client.innerApiCalls.createFlow = stubSimpleCall(expectedResponse);
            const [response] = await client.createFlow(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createFlow as SinonStub)
        ...
        it('invokes createFlow without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createFlow(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IFlow|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deleteFlow', () => {
        it('invokes deleteFlow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DeleteFlowRequest());
            request.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteFlow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getFlow', () => {
        it('invokes getFlow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.GetFlowRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getFlow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateFlow', () => {
        it('invokes updateFlow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.UpdateFlowRequest());
            request.flow = {};
            request.flow.name = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateFlow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('trainFlow', () => {
        it('invokes trainFlow without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.TrainFlowRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.trainFlow as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listFlows', () => {
        it('invokes listFlows without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ListFlowsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Flow()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Flow()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.Flow()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listFlows as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listFlowsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v3alpha1.Flow[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.Flow) => {
        ...
        it('uses async iteration with listFlows without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v3alpha1.IFlow[] = [];
