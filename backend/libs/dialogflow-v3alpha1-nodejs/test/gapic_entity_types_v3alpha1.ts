...
describe('v3alpha1.EntityTypesClient', () => {
    it('has servicePath', () => {
        const servicePath = entitytypesModule.v3alpha1.EntityTypesClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = entitytypesModule.v3alpha1.EntityTypesClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = entitytypesModule.v3alpha1.EntityTypesClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new entitytypesModule.v3alpha1.EntityTypesClient();
        assert(client);
    });
    ...
    describe('getEntityType', () => {
        it('invokes getEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.GetEntityTypeRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.EntityType());
        ...
        it('invokes getEntityType without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getEntityType(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v3alpha1.IEntityType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createEntityType', () => {
        it('invokes createEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.CreateEntityTypeRequest());
            request.parent = '';
    ...
    describe('updateEntityType', () => {
        it('invokes updateEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.UpdateEntityTypeRequest());
            request.entityType = {};
    ...
    describe('deleteEntityType', () => {
        it('invokes deleteEntityType without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.DeleteEntityTypeRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listEntityTypes', () => {
        it('invokes listEntityTypes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.ListEntityTypesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.EntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.EntityType()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v3alpha1.EntityType()),
            ];
        ...
        it('invokes listEntityTypesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v3alpha1.EntityType[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v3alpha1.EntityType) => {
        ...
        it('uses async iteration with listEntityTypes without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v3alpha1.IEntityType[] = [];
