 ...
 *  and pass it to the
 *  {@link google.cloud.dialogflow.v3alpha1.Sessions.DetectIntent|DetectIntent} method
...
export class SessionsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v3alpha1.Sessions', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.cloud.dialogflow.v3alpha1.Sessions.
    this.sessionsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v3alpha1.Sessions') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v3alpha1.Sessions,
  ...
  // -------------------
  detectIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IDetectIntentRequest,
      options?: gax.CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v3alpha1.IDetectIntentResponse,
        protos.google.cloud.dialogflow.v3alpha1.IDetectIntentRequest|undefined, {}|undefined
      ]>;
  detectIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IDetectIntentRequest,
      options: gax.CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v3alpha1.IDetectIntentResponse,
          protos.google.cloud.dialogflow.v3alpha1.IDetectIntentRequest|null|undefined,
          {}|null|undefined>): void;
  detectIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IDetectIntentRequest,
      callback: Callback<
 ...
 * @param {google.cloud.dialogflow.v3alpha1.QueryParameters} request.queryParams
 *   The parameters of this query.
 * @param {google.cloud.dialogflow.v3alpha1.QueryInput} request.queryInput
 *   Required. The input specification.
 * @param {google.cloud.dialogflow.v3alpha1.OutputAudioConfig} request.outputAudioConfig
 *   Instructs the speech synthesizer how to generate the output audio.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [DetectIntentResponse]{@link google.cloud.dialogflow.v3alpha1.DetectIntentResponse}.
 ...
 */
  ...
  matchIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IMatchIntentRequest,
      options?: gax.CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v3alpha1.IMatchIntentResponse,
        protos.google.cloud.dialogflow.v3alpha1.IMatchIntentRequest|undefined, {}|undefined
      ]>;
  matchIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IMatchIntentRequest,
      options: gax.CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v3alpha1.IMatchIntentResponse,
          protos.google.cloud.dialogflow.v3alpha1.IMatchIntentRequest|null|undefined,
          {}|null|undefined>): void;
  matchIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IMatchIntentRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MatchIntentResponse]{@link google.cloud.dialogflow.v3alpha1.MatchIntentResponse}.
 *   The promise has a method named "cancel" which cancels the ongoing API call.
 */
  matchIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IMatchIntentRequest,
  ...
  fulfillIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentRequest,
      options?: gax.CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentResponse,
        protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentRequest|undefined, {}|undefined
      ]>;
  fulfillIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentRequest,
      options: gax.CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentResponse,
          protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentRequest|null|undefined,
          {}|null|undefined>): void;
  fulfillIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentRequest,
      callback: Callback<
 ...
 * {@link google.cloud.dialogflow.v3alpha1.Sessions.MatchIntent|MatchIntent}. Must
 * be called after
 * {@link google.cloud.dialogflow.v3alpha1.Sessions.MatchIntent|MatchIntent}, with
 * input from
 * {@link google.cloud.dialogflow.v3alpha1.MatchIntentResponse|MatchIntentResponse}.
 * Otherwise, the behavior is undefined.
 *
 * @param {Object} request
 *   The request object that will be sent.
 * @param {google.cloud.dialogflow.v3alpha1.MatchIntentRequest} request.matchIntentRequest
 *   Must be same as the corresponding MatchIntent request, otherwise the
 *   behavior is undefined.
 * @param {google.cloud.dialogflow.v3alpha1.Match} request.match
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [FulfillIntentResponse]{@link google.cloud.dialogflow.v3alpha1.FulfillIntentResponse}.
 *   The promise has a method named "cancel" which cancels the ongoing API call.
 */
  fulfillIntent(
      request: protos.google.cloud.dialogflow.v3alpha1.IFulfillIntentRequest,
 ...
 *   representing [StreamingDetectIntentRequest]{@link google.cloud.dialogflow.v3alpha1.StreamingDetectIntentRequest} for write() method, and
 *   will emit objects representing [StreamingDetectIntentResponse]{@link google.cloud.dialogflow.v3alpha1.StreamingDetectIntentResponse} on 'data' event asynchronously.
 */
