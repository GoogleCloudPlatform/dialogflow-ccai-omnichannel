 ...
 * `src/v2/phone_numbers_client_config.json`.
...
/**
 *  Service for managing {@link google.cloud.dialogflow.v2.PhoneNumber|PhoneNumbers}.
 * @class
 * @memberof v2
 */
export class PhoneNumbersClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2.PhoneNumbers', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.cloud.dialogflow.v2.PhoneNumbers.
    this.phoneNumbersStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2.PhoneNumbers') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2.PhoneNumbers,
  ...
  // -------------------
  updatePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IUpdatePhoneNumberRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2.IPhoneNumber,
        protos.google.cloud.dialogflow.v2.IUpdatePhoneNumberRequest|undefined, {}|undefined
      ]>;
  updatePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IUpdatePhoneNumberRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IPhoneNumber,
          protos.google.cloud.dialogflow.v2.IUpdatePhoneNumberRequest|null|undefined,
          {}|null|undefined>): void;
  updatePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IUpdatePhoneNumberRequest,
      callback: Callback<
 ...
 * @param {google.cloud.dialogflow.v2.PhoneNumber} request.phoneNumber
 ...
 *   The first element of the array is an object representing [PhoneNumber]{@link google.cloud.dialogflow.v2.PhoneNumber}.
 *   Please see the
 ...
 */
  ...
  deletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IDeletePhoneNumberRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2.IPhoneNumber,
        protos.google.cloud.dialogflow.v2.IDeletePhoneNumberRequest|undefined, {}|undefined
      ]>;
  deletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IDeletePhoneNumberRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IPhoneNumber,
          protos.google.cloud.dialogflow.v2.IDeletePhoneNumberRequest|null|undefined,
          {}|null|undefined>): void;
  deletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IDeletePhoneNumberRequest,
      callback: Callback<
 ...
 * {@link google.cloud.dialogflow.v2.PhoneNumber.LifecycleState.DELETE_REQUESTED|DELETE_REQUESTED}
 * state immediately, and is deleted approximately 30 days later. This method
 * may only be called on a `PhoneNumber` in the
 * {@link google.cloud.dialogflow.v2.PhoneNumber.LifecycleState.ACTIVE|ACTIVE}
 * state.
 *
 * @param {Object} request
 *   The request object that will be sent.
 ...
 */
  ...
  undeletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IUndeletePhoneNumberRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2.IPhoneNumber,
        protos.google.cloud.dialogflow.v2.IUndeletePhoneNumberRequest|undefined, {}|undefined
      ]>;
  undeletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IUndeletePhoneNumberRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2.IPhoneNumber,
          protos.google.cloud.dialogflow.v2.IUndeletePhoneNumberRequest|null|undefined,
          {}|null|undefined>): void;
  undeletePhoneNumber(
      request: protos.google.cloud.dialogflow.v2.IUndeletePhoneNumberRequest,
      callback: Callback<
 ...
 */
  ...
  listPhoneNumbers(
      request: protos.google.cloud.dialogflow.v2.IListPhoneNumbersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2.IPhoneNumber[],
        protos.google.cloud.dialogflow.v2.IListPhoneNumbersRequest|null,
        protos.google.cloud.dialogflow.v2.IListPhoneNumbersResponse
      ]>;
  listPhoneNumbers(
      request: protos.google.cloud.dialogflow.v2.IListPhoneNumbersRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2.IListPhoneNumbersRequest,
          protos.google.cloud.dialogflow.v2.IListPhoneNumbersResponse|null|undefined,
          protos.google.cloud.dialogflow.v2.IPhoneNumber>): void;
  listPhoneNumbers(
      request: protos.google.cloud.dialogflow.v2.IListPhoneNumbersRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2.IListPhoneNumbersRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [PhoneNumber]{@link google.cloud.dialogflow.v2.PhoneNumber}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [PhoneNumber]{@link google.cloud.dialogflow.v2.PhoneNumber} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [PhoneNumber]{@link google.cloud.dialogflow.v2.PhoneNumber}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listPhoneNumbersAsync(
      request?: protos.google.cloud.dialogflow.v2.IListPhoneNumbersRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2.IPhoneNumber>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listPhoneNumbers.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2.IPhoneNumber>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
