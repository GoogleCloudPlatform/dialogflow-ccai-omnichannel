 ...
 * `src/v2beta1/human_agent_assistants_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './human_agent_assistants_client_config.json';

const version = require('../../../package.json').version;

/**
 *  Deprecated: use configs in
 *  {@link google.cloud.dialogflow.v2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig|HumanAgentAssistantConfig.SuggestionFeatureConfig}
 *  of {@link google.cloud.dialogflow.v2beta1.ConversationProfile|ConversationProfile}
 *  Removal Date: 2020-09-01. From 2020-06-08, we will disable
 *  {@link google.cloud.dialogflow.v2beta1.HumanAgentAssistants.CreateHumanAgentAssistant|HumanAgentAssistants.CreateHumanAgentAssistant}.
 ...
 * @memberof v2beta1
 */
export class HumanAgentAssistantsClient {
  ...
  humanAgentAssistantsStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of HumanAgentAssistantsClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof HumanAgentAssistantsClient;
    ...
    this.descriptors.page = {
      listHumanAgentAssistants:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'humanAgentAssistants')
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2beta1.HumanAgentAssistants', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.humanAgentAssistantsStub) {
      return this.humanAgentAssistantsStub;
    }

    // Put together the "service stub" for
    // google.cloud.dialogflow.v2beta1.HumanAgentAssistants.
    this.humanAgentAssistantsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.HumanAgentAssistants') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2beta1.HumanAgentAssistants,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const humanAgentAssistantsStubMethods =
        ['listHumanAgentAssistants', 'getHumanAgentAssistant', 'createHumanAgentAssistant', 'updateHumanAgentAssistant', 'deleteHumanAgentAssistant', 'compileSuggestions'];
    for (const methodName of humanAgentAssistantsStubMethods) {
      const callPromise = this.humanAgentAssistantsStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -- Service calls --
  // -------------------
  getHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IGetHumanAgentAssistantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant,
        protos.google.cloud.dialogflow.v2beta1.IGetHumanAgentAssistantRequest|undefined, {}|undefined
      ]>;
  getHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IGetHumanAgentAssistantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant,
          protos.google.cloud.dialogflow.v2beta1.IGetHumanAgentAssistantRequest|null|undefined,
          {}|null|undefined>): void;
  getHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IGetHumanAgentAssistantRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [HumanAgentAssistant]{@link google.cloud.dialogflow.v2beta1.HumanAgentAssistant}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.getHumanAgentAssistant(request);
 */
  getHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IGetHumanAgentAssistantRequest,
    ...
    this.initialize();
    return this.innerApiCalls.getHumanAgentAssistant(request, options, callback);
  }
  createHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateHumanAgentAssistantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant,
        protos.google.cloud.dialogflow.v2beta1.ICreateHumanAgentAssistantRequest|undefined, {}|undefined
      ]>;
  createHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateHumanAgentAssistantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant,
          protos.google.cloud.dialogflow.v2beta1.ICreateHumanAgentAssistantRequest|null|undefined,
          {}|null|undefined>): void;
  createHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateHumanAgentAssistantRequest,
      callback: Callback<
 ...
 * Deprecated. Use
 * {@link google.cloud.dialogflow.v2beta1.ConversationProfiles.CreateConversationProfile|ConversationProfiles.CreateConversationProfile}
 * instead.
 *
 * Starting 2020-06-08, this method will always return INVALID_ARGUMENT. If
 * you need to continue using this method, you can set
 * {@link google.cloud.dialogflow.v2beta1.CreateHumanAgentAssistantRequest.bypass_deprecation|CreateHumanAgentAssistantRequest.bypass_deprecation}
 ...
 * @param {google.cloud.dialogflow.v2beta1.HumanAgentAssistant} request.humanAgentAssistant
 *   Required. The agent assistant to create.
 * @param {boolean} request.bypassDeprecation
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.createHumanAgentAssistant(request);
 */
  createHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateHumanAgentAssistantRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.createHumanAgentAssistant(request, options, callback);
  }
  updateHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateHumanAgentAssistantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant,
        protos.google.cloud.dialogflow.v2beta1.IUpdateHumanAgentAssistantRequest|undefined, {}|undefined
      ]>;
  updateHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateHumanAgentAssistantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant,
          protos.google.cloud.dialogflow.v2beta1.IUpdateHumanAgentAssistantRequest|null|undefined,
          {}|null|undefined>): void;
  updateHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateHumanAgentAssistantRequest,
      callback: Callback<
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.updateHumanAgentAssistant(request);
 */
  updateHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateHumanAgentAssistantRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    options.otherArgs.headers[
      ...
      'human_agent_assistant.name': request.humanAgentAssistant!.name || '',
    });
    this.initialize();
    return this.innerApiCalls.updateHumanAgentAssistant(request, options, callback);
  }
  deleteHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteHumanAgentAssistantRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.cloud.dialogflow.v2beta1.IDeleteHumanAgentAssistantRequest|undefined, {}|undefined
      ]>;
  deleteHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteHumanAgentAssistantRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.v2beta1.IDeleteHumanAgentAssistantRequest|null|undefined,
          {}|null|undefined>): void;
  deleteHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteHumanAgentAssistantRequest,
      callback: Callback<
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.deleteHumanAgentAssistant(request);
 */
  deleteHumanAgentAssistant(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteHumanAgentAssistantRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.deleteHumanAgentAssistant(request, options, callback);
  }
  compileSuggestions(
      request: protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsResponse,
        protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsRequest|undefined, {}|undefined
      ]>;
  compileSuggestions(
      request: protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsResponse,
          protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsRequest|null|undefined,
          {}|null|undefined>): void;
  compileSuggestions(
      request: protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [CompileSuggestionsResponse]{@link google.cloud.dialogflow.v2beta1.CompileSuggestionsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.compileSuggestions(request);
 */
  compileSuggestions(
      request: protos.google.cloud.dialogflow.v2beta1.ICompileSuggestionsRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.compileSuggestions(request, options, callback);
  }

  listHumanAgentAssistants(
      request: protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant[],
        protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest|null,
        protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsResponse
      ]>;
  listHumanAgentAssistants(
      request: protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest,
          protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsResponse|null|undefined,
          protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant>): void;
  listHumanAgentAssistants(
      request: protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [HumanAgentAssistant]{@link google.cloud.dialogflow.v2beta1.HumanAgentAssistant}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listHumanAgentAssistantsAsync()`
 ...
 */
  listHumanAgentAssistants(
    ...
    this.initialize();
    return this.innerApiCalls.listHumanAgentAssistants(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [HumanAgentAssistant]{@link google.cloud.dialogflow.v2beta1.HumanAgentAssistant} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   for more details and examples.
 */
  listHumanAgentAssistantsStream(
      request?: protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest,
      options?: CallOptions):
    Transform{
    request = request || {};
    ...
    this.initialize();
    return this.descriptors.page.listHumanAgentAssistants.createStream(
      this.innerApiCalls.listHumanAgentAssistants as gax.GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listHumanAgentAssistants`, but returns an iterable object.
 *
 ...
 *   [HumanAgentAssistant]{@link google.cloud.dialogflow.v2beta1.HumanAgentAssistant}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 * @example
 * const iterable = client.listHumanAgentAssistantsAsync(request);
 * for await (const response of iterable) {
 *   // process response
 * }
 */
  listHumanAgentAssistantsAsync(
      request?: protos.google.cloud.dialogflow.v2beta1.IListHumanAgentAssistantsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = new gax.CallSettings(options);
    this.initialize();
    return this.descriptors.page.listHumanAgentAssistants.asyncIterate(
      this.innerApiCalls['listHumanAgentAssistants'] as GaxCall,
      request as unknown as RequestType,
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IHumanAgentAssistant>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.humanAgentAssistantsStub!.then(stub => {
