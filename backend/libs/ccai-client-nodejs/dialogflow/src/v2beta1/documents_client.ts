...
export class DocumentsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    const exportDocumentMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata') as gax.protobuf.Type;
    const generateDocumentResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.Document') as gax.protobuf.Type;
    const generateDocumentMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.GenerateDocumentOperationMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      generateDocument: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        generateDocumentResponse.decode.bind(generateDocumentResponse),
        generateDocumentMetadata.decode.bind(generateDocumentMetadata))
    };
  ...
  initialize() {
    ...
    const documentsStubMethods =
        ['listDocuments', 'getDocument', 'createDocument', 'importDocuments', 'deleteDocument', 'updateDocument', 'reloadDocument', 'exportDocument', 'generateDocument'];
 ...
 */
  ...
  exportDocument(
      request: protos.google.cloud.dialogflow.v2beta1.IExportDocumentRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2beta1.IDocument, protos.google.cloud.dialogflow.v2beta1.IKnowledgeOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkExportDocumentProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkExportDocumentProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.Document, protos.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
  ...
  generateDocument(
      request: protos.google.cloud.dialogflow.v2beta1.IGenerateDocumentRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2beta1.IDocument, protos.google.cloud.dialogflow.v2beta1.IGenerateDocumentOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  generateDocument(
      request: protos.google.cloud.dialogflow.v2beta1.IGenerateDocumentRequest,
 ...
 *   Format: `projects/<Project ID>/locations/<Location
 *   ID>/knowledgeBases/<Knowledge Base ID>`.
 * @param {google.cloud.dialogflow.v2beta1.InputDatasets} request.trainingDatasets
 *   The conversation datasets to be used for generating document.
 * @param {google.cloud.dialogflow.v2beta1.Document.KnowledgeType} request.knowledgeType
 ...
 *   for more details and examples.
 * @example
 * const [operation] = await client.generateDocument(request);
 * const [response] = await operation.promise();
 */
  generateDocument(
      request: protos.google.cloud.dialogflow.v2beta1.IGenerateDocumentRequest,
    ...
    this.initialize();
    return this.innerApiCalls.generateDocument(request, options, callback);
  }
/**
 * Check the status of the long running operation returned by `generateDocument()`.
 * @param {String} name
 *   The operation name that will be passed.
 * @returns {Promise} - The promise which resolves to an object.
 *   The decoded operation object has result and metadata field to get information from.
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkGenerateDocumentProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkGenerateDocumentProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.Document, protos.google.cloud.dialogflow.v2beta1.GenerateDocumentOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.generateDocument, gax.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2beta1.Document, protos.google.cloud.dialogflow.v2beta1.GenerateDocumentOperationMetadata>;
  }
  listDocuments(
