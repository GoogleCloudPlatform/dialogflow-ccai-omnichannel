 ...
 * `src/v2beta1/conversation_datasets_client_config.json`.
...
export class ConversationDatasetsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.pathTemplates = {
      ...
      projectConversationDatasetPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/conversationDatasets/{conversation_dataset}'
      ),
      projectConversationDatasetAnnotatedConversationDatasetPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/conversationDatasets/{conversation_dataset}/annotatedConversationDatasets/{annotated_conversation_dataset}'
      ),
      ...
      projectLocationConversationDatasetPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/locations/{location}/conversationDatasets/{conversation_dataset}'
      ),
      projectLocationConversationDatasetAnnotatedConversationDatasetPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/locations/{location}/conversationDatasets/{conversation_dataset}/annotatedConversationDatasets/{annotated_conversation_dataset}'
      ),
      ...
      projectLocationPhoneNumberPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/locations/{location}/phoneNumber/{phone_number}'
      ),
      projectLocationPhoneNumberOrderPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/locations/{location}/phoneNumberOrders/{phone_number_order}'
      ),
      projectPhoneNumberPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/phoneNumber/{phone_number}'
      ),
      projectPhoneNumberOrderPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/phoneNumberOrders/{phone_number_order}'
      ),
      securitySettingsPathTemplate: new this._gaxModule.PathTemplate(
        'projects/{project}/securitySettings'
      ),
    };
    ...
    this.descriptors.page = {
      ...
      listAnnotatedConversationDatasets:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'annotatedConversationDatasets')
    };
    ...
    const createConversationDatasetResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.ConversationDataset') as gax.protobuf.Type;
    const createConversationDatasetMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.CreateConversationDatasetOperationMetadata') as gax.protobuf.Type;
    ...
    const deleteConversationDatasetMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.DeleteConversationDatasetOperationMetadata') as gax.protobuf.Type;
    const importConversationDataResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.ImportConversationDataOperationResponse') as gax.protobuf.Type;
    const importConversationDataMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.ImportConversationDataOperationMetadata') as gax.protobuf.Type;
    const labelConversationResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.LabelConversationResponse') as gax.protobuf.Type;
    const labelConversationMetadata = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.LabelConversationOperationMetadata') as gax.protobuf.Type;
    ...
    this.descriptors.longrunning = {
      ...
      labelConversation: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        labelConversationResponse.decode.bind(labelConversationResponse),
        labelConversationMetadata.decode.bind(labelConversationMetadata))
    };

    // Put together the default options sent with requests.
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2beta1.ConversationDatasets', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    // google.cloud.dialogflow.v2beta1.ConversationDatasets.
    this.conversationDatasetsStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.ConversationDatasets') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2beta1.ConversationDatasets,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const conversationDatasetsStubMethods =
        ['createConversationDataset', 'getConversationDataset', 'listConversationDatasets', 'deleteConversationDataset', 'getAnnotatedConversationDataset', 'listAnnotatedConversationDatasets', 'deleteAnnotatedConversationDataset', 'importConversationData', 'labelConversation'];
  ...
  getConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IGetConversationDatasetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IConversationDataset,
        protos.google.cloud.dialogflow.v2beta1.IGetConversationDatasetRequest|undefined, {}|undefined
      ]>;
  getConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IGetConversationDatasetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IConversationDataset,
          protos.google.cloud.dialogflow.v2beta1.IGetConversationDatasetRequest|null|undefined,
          {}|null|undefined>): void;
  getConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IGetConversationDatasetRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [ConversationDataset]{@link google.cloud.dialogflow.v2beta1.ConversationDataset}.
 *   Please see the
 ...
 */
  ...
  getAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IGetAnnotatedConversationDatasetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IAnnotatedConversationDataset,
        protos.google.cloud.dialogflow.v2beta1.IGetAnnotatedConversationDatasetRequest|undefined, {}|undefined
      ]>;
  getAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IGetAnnotatedConversationDatasetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IAnnotatedConversationDataset,
          protos.google.cloud.dialogflow.v2beta1.IGetAnnotatedConversationDatasetRequest|null|undefined,
          {}|null|undefined>): void;
  getAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IGetAnnotatedConversationDatasetRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [AnnotatedConversationDataset]{@link google.cloud.dialogflow.v2beta1.AnnotatedConversationDataset}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.getAnnotatedConversationDataset(request);
 */
  getAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IGetAnnotatedConversationDatasetRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.getAnnotatedConversationDataset(request, options, callback);
  }
  deleteAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAnnotatedConversationDatasetRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
        protos.google.cloud.dialogflow.v2beta1.IDeleteAnnotatedConversationDatasetRequest|undefined, {}|undefined
      ]>;
  deleteAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAnnotatedConversationDatasetRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.v2beta1.IDeleteAnnotatedConversationDatasetRequest|null|undefined,
          {}|null|undefined>): void;
  deleteAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAnnotatedConversationDatasetRequest,
      callback: Callback<
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.deleteAnnotatedConversationDataset(request);
 */
  deleteAnnotatedConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAnnotatedConversationDatasetRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.deleteAnnotatedConversationDataset(request, options, callback);
  }

  createConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateConversationDatasetRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2beta1.IConversationDataset, protos.google.cloud.dialogflow.v2beta1.ICreateConversationDatasetOperationMetadata>,
 ...
 *   `projects/<Project ID>`
 * @param {google.cloud.dialogflow.v2beta1.ConversationDataset} request.conversationDataset
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkCreateConversationDatasetProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkCreateConversationDatasetProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.ConversationDataset, protos.google.cloud.dialogflow.v2beta1.CreateConversationDatasetOperationMetadata>>{
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2beta1.ConversationDataset, protos.google.cloud.dialogflow.v2beta1.CreateConversationDatasetOperationMetadata>;
  }
  deleteConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteConversationDatasetRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2beta1.IDeleteConversationDatasetOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  deleteConversationDataset(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteConversationDatasetRequest,
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkDeleteConversationDatasetProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkDeleteConversationDatasetProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.dialogflow.v2beta1.DeleteConversationDatasetOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.protobuf.Empty, protos.google.cloud.dialogflow.v2beta1.DeleteConversationDatasetOperationMetadata>;
  }
  importConversationData(
      request: protos.google.cloud.dialogflow.v2beta1.IImportConversationDataRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2beta1.IImportConversationDataOperationResponse, protos.google.cloud.dialogflow.v2beta1.IImportConversationDataOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  importConversationData(
      request: protos.google.cloud.dialogflow.v2beta1.IImportConversationDataRequest,
 ...
 *
 * Operation <response:
 * {@link google.cloud.dialogflow.v2beta1.ImportConversationDataOperationResponse|ImportConversationDataOperationResponse},
 *            metadata:
 *            {@link google.cloud.dialogflow.v2beta1.ImportConversationDataOperationMetadata|ImportConversationDataOperationMetadata}>
 *
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.name
 ...
 *   `projects/<Project ID>/conversationDatasets/<Conversation Dataset ID>`
 * @param {google.cloud.dialogflow.v2beta1.InputConfig} request.inputConfig
 *   Required. Configurations that contains information of raw file location,
 *   raw file type, etc.
 * @param {google.cloud.dialogflow.v2beta1.ConversationInfo} [request.conversationInfo]
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkImportConversationDataProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkImportConversationDataProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.ImportConversationDataOperationResponse, protos.google.cloud.dialogflow.v2beta1.ImportConversationDataOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    ...
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2beta1.ImportConversationDataOperationResponse, protos.google.cloud.dialogflow.v2beta1.ImportConversationDataOperationMetadata>;
  }
  labelConversation(
      request: protos.google.cloud.dialogflow.v2beta1.ILabelConversationRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2beta1.ILabelConversationResponse, protos.google.cloud.dialogflow.v2beta1.ILabelConversationOperationMetadata>,
        protos.google.longrunning.IOperation|undefined, {}|undefined
      ]>;
  labelConversation(
      request: protos.google.cloud.dialogflow.v2beta1.ILabelConversationRequest,
 ...
 *
 * Operation <response:
 * {@link google.cloud.dialogflow.v2beta1.LabelConversationResponse|LabelConversationResponse},
 *            metadata:
 *            {@link google.cloud.dialogflow.v2beta1.LabelConversationOperationMetadata|LabelConversationOperationMetadata}>
 *
 * @param {Object} request
 *   The request object that will be sent.
 * @param {string} request.parent
 ...
 *   `projects/<Project ID>/conversationDatasets/<Conversation Dataset ID>`
 * @param {google.cloud.dialogflow.v2beta1.AnnotationTaskConfig} request.annotationTaskConfig
 ...
 *   for more details and examples.
 * @example
 * const [operation] = await client.labelConversation(request);
 * const [response] = await operation.promise();
 */
  labelConversation(
      request: protos.google.cloud.dialogflow.v2beta1.ILabelConversationRequest,
    ...
    this.initialize();
    return this.innerApiCalls.labelConversation(request, options, callback);
  }
/**
 * Check the status of the long running operation returned by `labelConversation()`.
 * @param {String} name
 *   The operation name that will be passed.
 * @returns {Promise} - The promise which resolves to an object.
 *   The decoded operation object has result and metadata field to get information from.
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkLabelConversationProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkLabelConversationProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.LabelConversationResponse, protos.google.cloud.dialogflow.v2beta1.LabelConversationOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.labelConversation, gax.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2beta1.LabelConversationResponse, protos.google.cloud.dialogflow.v2beta1.LabelConversationOperationMetadata>;
  }
  listConversationDatasets(
      request: protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IConversationDataset[],
        protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsRequest|null,
        protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsResponse
      ]>;
  listConversationDatasets(
      request: protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsRequest,
          protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsResponse|null|undefined,
          protos.google.cloud.dialogflow.v2beta1.IConversationDataset>): void;
  listConversationDatasets(
      request: protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [ConversationDataset]{@link google.cloud.dialogflow.v2beta1.ConversationDataset}.
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [ConversationDataset]{@link google.cloud.dialogflow.v2beta1.ConversationDataset} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 ...
 *   [ConversationDataset]{@link google.cloud.dialogflow.v2beta1.ConversationDataset}. The API will be called under the hood as needed, once per the page,
 ...
 */
  listConversationDatasetsAsync(
      request?: protos.google.cloud.dialogflow.v2beta1.IListConversationDatasetsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IConversationDataset>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.listConversationDatasets.asyncIterate(
      ...
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IConversationDataset>;
  }
  listAnnotatedConversationDatasets(
      request: protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IAnnotatedConversationDataset[],
        protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest|null,
        protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsResponse
      ]>;
  listAnnotatedConversationDatasets(
      request: protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest,
      options: CallOptions,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest,
          protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsResponse|null|undefined,
          protos.google.cloud.dialogflow.v2beta1.IAnnotatedConversationDataset>): void;
  listAnnotatedConversationDatasets(
      request: protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest,
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is Array of [AnnotatedConversationDataset]{@link google.cloud.dialogflow.v2beta1.AnnotatedConversationDataset}.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listAnnotatedConversationDatasetsAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 */
  listAnnotatedConversationDatasets(
    ...
    this.initialize();
    return this.innerApiCalls.listAnnotatedConversationDatasets(request, options, callback);
  }
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Stream}
 *   An object stream which emits an object representing [AnnotatedConversationDataset]{@link google.cloud.dialogflow.v2beta1.AnnotatedConversationDataset} on 'data' event.
 *   The client library will perform auto-pagination by default: it will call the API as many
 *   times as needed. Note that it can affect your quota.
 *   We recommend using `listAnnotatedConversationDatasetsAsync()`
 *   method described below for async iteration which you can stop as needed.
 ...
 *   for more details and examples.
 */
  listAnnotatedConversationDatasetsStream(
      request?: protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest,
      options?: CallOptions):
    Transform{
    request = request || {};
    ...
    const callSettings = new gax.CallSettings(options);
    this.initialize();
    return this.descriptors.page.listAnnotatedConversationDatasets.createStream(
      this.innerApiCalls.listAnnotatedConversationDatasets as gax.GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listAnnotatedConversationDatasets`, but returns an iterable object.
 *
 * `for`-`await`-`of` syntax is used with the iterable to get response elements on-demand.
 * @param {Object} request
 *   The request object that will be sent.
 ...
 *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
 *   When you iterate the returned iterable, each element will be an object representing
 *   [AnnotatedConversationDataset]{@link google.cloud.dialogflow.v2beta1.AnnotatedConversationDataset}. The API will be called under the hood as needed, once per the page,
 *   so you can stop the iteration when you don't need more results.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 * @example
 * const iterable = client.listAnnotatedConversationDatasetsAsync(request);
 * for await (const response of iterable) {
 *   // process response
 * }
 */
  listAnnotatedConversationDatasetsAsync(
      request?: protos.google.cloud.dialogflow.v2beta1.IListAnnotatedConversationDatasetsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IAnnotatedConversationDataset>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    const callSettings = new gax.CallSettings(options);
    this.initialize();
    return this.descriptors.page.listAnnotatedConversationDatasets.asyncIterate(
      this.innerApiCalls['listAnnotatedConversationDatasets'] as GaxCall,
      request as unknown as RequestType,
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IAnnotatedConversationDataset>;
  }
  // --------------------
  // -- Path templates --
  // --------------------
  ...
  /**
   * Return a fully-qualified projectConversationDataset resource name string.
   *
   * @param {string} project
   * @param {string} conversation_dataset
   * @returns {string} Resource name string.
   */
  projectConversationDatasetPath(project:string,conversationDataset:string) {
    return this.pathTemplates.projectConversationDatasetPathTemplate.render({
      project: project,
  ...
  /**
   * Parse the project from ProjectConversationDataset resource.
   *
   * @param {string} projectConversationDatasetName
   *   A fully-qualified path representing project_conversation_dataset resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectConversationDatasetName(projectConversationDatasetName: string) {
    return this.pathTemplates.projectConversationDatasetPathTemplate.match(projectConversationDatasetName).project;
  }

  /**
   * Parse the conversation_dataset from ProjectConversationDataset resource.
   *
   * @param {string} projectConversationDatasetName
   *   A fully-qualified path representing project_conversation_dataset resource.
   * @returns {string} A string representing the conversation_dataset.
   */
  matchConversationDatasetFromProjectConversationDatasetName(projectConversationDatasetName: string) {
    return this.pathTemplates.projectConversationDatasetPathTemplate.match(projectConversationDatasetName).conversation_dataset;
  }

  /**
   * Return a fully-qualified projectConversationDatasetAnnotatedConversationDataset resource name string.
   *
   * @param {string} project
   * @param {string} conversation_dataset
   * @param {string} annotated_conversation_dataset
   * @returns {string} Resource name string.
   */
  projectConversationDatasetAnnotatedConversationDatasetPath(project:string,conversationDataset:string,annotatedConversationDataset:string) {
    return this.pathTemplates.projectConversationDatasetAnnotatedConversationDatasetPathTemplate.render({
      project: project,
      conversation_dataset: conversationDataset,
      annotated_conversation_dataset: annotatedConversationDataset,
    });
  }

  /**
   * Parse the project from ProjectConversationDatasetAnnotatedConversationDataset resource.
   *
   * @param {string} projectConversationDatasetAnnotatedConversationDatasetName
   *   A fully-qualified path representing project_conversation_dataset_annotated_conversation_dataset resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectConversationDatasetAnnotatedConversationDatasetName(projectConversationDatasetAnnotatedConversationDatasetName: string) {
    return this.pathTemplates.projectConversationDatasetAnnotatedConversationDatasetPathTemplate.match(projectConversationDatasetAnnotatedConversationDatasetName).project;
  }

  /**
   * Parse the conversation_dataset from ProjectConversationDatasetAnnotatedConversationDataset resource.
   *
   * @param {string} projectConversationDatasetAnnotatedConversationDatasetName
   *   A fully-qualified path representing project_conversation_dataset_annotated_conversation_dataset resource.
   * @returns {string} A string representing the conversation_dataset.
   */
  matchConversationDatasetFromProjectConversationDatasetAnnotatedConversationDatasetName(projectConversationDatasetAnnotatedConversationDatasetName: string) {
    return this.pathTemplates.projectConversationDatasetAnnotatedConversationDatasetPathTemplate.match(projectConversationDatasetAnnotatedConversationDatasetName).conversation_dataset;
  }

  /**
   * Parse the annotated_conversation_dataset from ProjectConversationDatasetAnnotatedConversationDataset resource.
   *
   * @param {string} projectConversationDatasetAnnotatedConversationDatasetName
   *   A fully-qualified path representing project_conversation_dataset_annotated_conversation_dataset resource.
   * @returns {string} A string representing the annotated_conversation_dataset.
   */
  matchAnnotatedConversationDatasetFromProjectConversationDatasetAnnotatedConversationDatasetName(projectConversationDatasetAnnotatedConversationDatasetName: string) {
    return this.pathTemplates.projectConversationDatasetAnnotatedConversationDatasetPathTemplate.match(projectConversationDatasetAnnotatedConversationDatasetName).annotated_conversation_dataset;
  }
  ...
  /**
   * Return a fully-qualified projectLocationConversationDataset resource name string.
   *
   * @param {string} project
   * @param {string} location
   * @param {string} conversation_dataset
   * @returns {string} Resource name string.
   */
  projectLocationConversationDatasetPath(project:string,location:string,conversationDataset:string) {
    return this.pathTemplates.projectLocationConversationDatasetPathTemplate.render({
      project: project,
      location: location,
      conversation_dataset: conversationDataset,
    });
  ...
  /**
   * Parse the project from ProjectLocationConversationDataset resource.
   *
   * @param {string} projectLocationConversationDatasetName
   *   A fully-qualified path representing project_location_conversation_dataset resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationConversationDatasetName(projectLocationConversationDatasetName: string) {
    return this.pathTemplates.projectLocationConversationDatasetPathTemplate.match(projectLocationConversationDatasetName).project;
  }

  /**
   * Parse the location from ProjectLocationConversationDataset resource.
   *
   * @param {string} projectLocationConversationDatasetName
   *   A fully-qualified path representing project_location_conversation_dataset resource.
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationConversationDatasetName(projectLocationConversationDatasetName: string) {
    return this.pathTemplates.projectLocationConversationDatasetPathTemplate.match(projectLocationConversationDatasetName).location;
  }

  /**
   * Parse the conversation_dataset from ProjectLocationConversationDataset resource.
   *
   * @param {string} projectLocationConversationDatasetName
   *   A fully-qualified path representing project_location_conversation_dataset resource.
   * @returns {string} A string representing the conversation_dataset.
   */
  matchConversationDatasetFromProjectLocationConversationDatasetName(projectLocationConversationDatasetName: string) {
    return this.pathTemplates.projectLocationConversationDatasetPathTemplate.match(projectLocationConversationDatasetName).conversation_dataset;
  }

  /**
   * Return a fully-qualified projectLocationConversationDatasetAnnotatedConversationDataset resource name string.
   *
   * @param {string} project
   * @param {string} location
   * @param {string} conversation_dataset
   ...
   * @returns {string} Resource name string.
   */
  projectLocationConversationDatasetAnnotatedConversationDatasetPath(project:string,location:string,conversationDataset:string,annotatedConversationDataset:string) {
    return this.pathTemplates.projectLocationConversationDatasetAnnotatedConversationDatasetPathTemplate.render({
      project: project,
      location: location,
      conversation_dataset: conversationDataset,
      annotated_conversation_dataset: annotatedConversationDataset,
  ...
  /**
   * Parse the project from ProjectLocationConversationDatasetAnnotatedConversationDataset resource.
   *
   * @param {string} projectLocationConversationDatasetAnnotatedConversationDatasetName
   *   A fully-qualified path representing project_location_conversation_dataset_annotated_conversation_dataset resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationConversationDatasetAnnotatedConversationDatasetName(projectLocationConversationDatasetAnnotatedConversationDatasetName: string) {
    return this.pathTemplates.projectLocationConversationDatasetAnnotatedConversationDatasetPathTemplate.match(projectLocationConversationDatasetAnnotatedConversationDatasetName).project;
  }

  /**
   * Parse the location from ProjectLocationConversationDatasetAnnotatedConversationDataset resource.
   *
   * @param {string} projectLocationConversationDatasetAnnotatedConversationDatasetName
   *   A fully-qualified path representing project_location_conversation_dataset_annotated_conversation_dataset resource.
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationConversationDatasetAnnotatedConversationDatasetName(projectLocationConversationDatasetAnnotatedConversationDatasetName: string) {
    return this.pathTemplates.projectLocationConversationDatasetAnnotatedConversationDatasetPathTemplate.match(projectLocationConversationDatasetAnnotatedConversationDatasetName).location;
  }

  /**
   * Parse the conversation_dataset from ProjectLocationConversationDatasetAnnotatedConversationDataset resource.
   *
   * @param {string} projectLocationConversationDatasetAnnotatedConversationDatasetName
   *   A fully-qualified path representing project_location_conversation_dataset_annotated_conversation_dataset resource.
   * @returns {string} A string representing the conversation_dataset.
   */
  matchConversationDatasetFromProjectLocationConversationDatasetAnnotatedConversationDatasetName(projectLocationConversationDatasetAnnotatedConversationDatasetName: string) {
    return this.pathTemplates.projectLocationConversationDatasetAnnotatedConversationDatasetPathTemplate.match(projectLocationConversationDatasetAnnotatedConversationDatasetName).conversation_dataset;
  }

  /**
   * Parse the annotated_conversation_dataset from ProjectLocationConversationDatasetAnnotatedConversationDataset resource.
   *
   * @param {string} projectLocationConversationDatasetAnnotatedConversationDatasetName
   *   A fully-qualified path representing project_location_conversation_dataset_annotated_conversation_dataset resource.
   * @returns {string} A string representing the annotated_conversation_dataset.
   */
  matchAnnotatedConversationDatasetFromProjectLocationConversationDatasetAnnotatedConversationDatasetName(projectLocationConversationDatasetAnnotatedConversationDatasetName: string) {
    return this.pathTemplates.projectLocationConversationDatasetAnnotatedConversationDatasetPathTemplate.match(projectLocationConversationDatasetAnnotatedConversationDatasetName).annotated_conversation_dataset;
  }
  ...
  /**
   * Return a fully-qualified projectLocationPhoneNumberOrder resource name string.
   *
   * @param {string} project
   * @param {string} location
   * @param {string} phone_number_order
   * @returns {string} Resource name string.
   */
  projectLocationPhoneNumberOrderPath(project:string,location:string,phoneNumberOrder:string) {
    return this.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.render({
      project: project,
      location: location,
  ...
  /**
   * Parse the project from ProjectLocationPhoneNumberOrder resource.
   *
   * @param {string} projectLocationPhoneNumberOrderName
   *   A fully-qualified path representing project_location_phone_number_order resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectLocationPhoneNumberOrderName(projectLocationPhoneNumberOrderName: string) {
    return this.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.match(projectLocationPhoneNumberOrderName).project;
  }

  /**
   * Parse the location from ProjectLocationPhoneNumberOrder resource.
   *
   * @param {string} projectLocationPhoneNumberOrderName
   *   A fully-qualified path representing project_location_phone_number_order resource.
   * @returns {string} A string representing the location.
   */
  matchLocationFromProjectLocationPhoneNumberOrderName(projectLocationPhoneNumberOrderName: string) {
    return this.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.match(projectLocationPhoneNumberOrderName).location;
  }

  /**
   * Parse the phone_number_order from ProjectLocationPhoneNumberOrder resource.
   *
   * @param {string} projectLocationPhoneNumberOrderName
   *   A fully-qualified path representing project_location_phone_number_order resource.
   * @returns {string} A string representing the phone_number_order.
   */
  matchPhoneNumberOrderFromProjectLocationPhoneNumberOrderName(projectLocationPhoneNumberOrderName: string) {
    return this.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.match(projectLocationPhoneNumberOrderName).phone_number_order;
  }
  ...
  /**
   * Return a fully-qualified projectPhoneNumberOrder resource name string.
   *
   * @param {string} project
   * @param {string} phone_number_order
   * @returns {string} Resource name string.
   */
  projectPhoneNumberOrderPath(project:string,phoneNumberOrder:string) {
    return this.pathTemplates.projectPhoneNumberOrderPathTemplate.render({
      project: project,
      phone_number_order: phoneNumberOrder,
    });
  }
  ...
  /**
   * Parse the project from ProjectPhoneNumberOrder resource.
   *
   * @param {string} projectPhoneNumberOrderName
   *   A fully-qualified path representing project_phone_number_order resource.
   * @returns {string} A string representing the project.
   */
  matchProjectFromProjectPhoneNumberOrderName(projectPhoneNumberOrderName: string) {
    return this.pathTemplates.projectPhoneNumberOrderPathTemplate.match(projectPhoneNumberOrderName).project;
  }

  /**
   * Parse the phone_number_order from ProjectPhoneNumberOrder resource.
   *
   * @param {string} projectPhoneNumberOrderName
   *   A fully-qualified path representing project_phone_number_order resource.
   * @returns {string} A string representing the phone_number_order.
   */
  matchPhoneNumberOrderFromProjectPhoneNumberOrderName(projectPhoneNumberOrderName: string) {
    return this.pathTemplates.projectPhoneNumberOrderPathTemplate.match(projectPhoneNumberOrderName).phone_number_order;
  }
   ...
   * @returns {string} Resource name string.
   */
  securitySettingsPath(project:string) {
