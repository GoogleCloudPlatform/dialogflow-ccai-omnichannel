 ...
 * `src/v2beta1/asynchronous_fulfillment_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
import * as gapicConfig from './asynchronous_fulfillment_client_config.json';
 ...
 *  {@link google.cloud.dialogflow.v2beta1.AsynchronousFulfillment.PushFulfillmentResult|PushFulfillmentResult}
 *  method.
 * @class
 * @memberof v2beta1
 */
export class AsynchronousFulfillmentClient {
  ...
  asynchronousFulfillmentStub?: Promise<{[name: string]: Function}>;

  /**
   * Construct an instance of AsynchronousFulfillmentClient.
   *
  ...
  constructor(opts?: ClientOptions) {
    ...
    const staticMembers = this.constructor as typeof AsynchronousFulfillmentClient;
    ...
    this._defaults = this._gaxGrpc.constructSettings(
        'google.cloud.dialogflow.v2beta1.AsynchronousFulfillment', gapicConfig as gax.ClientConfig,
  ...
  initialize() {
    ...
    if (this.asynchronousFulfillmentStub) {
      return this.asynchronousFulfillmentStub;
    }

    // Put together the "service stub" for
    // google.cloud.dialogflow.v2beta1.AsynchronousFulfillment.
    this.asynchronousFulfillmentStub = this._gaxGrpc.createStub(
        this._opts.fallback ?
          (this._protos as protobuf.Root).lookupService('google.cloud.dialogflow.v2beta1.AsynchronousFulfillment') :
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.dialogflow.v2beta1.AsynchronousFulfillment,
        this._opts) as Promise<{[method: string]: Function}>;

    // Iterate over each of the methods that the service provides
    // and create an API call method for each.
    const asynchronousFulfillmentStubMethods =
        ['pushFulfillmentResult'];
    for (const methodName of asynchronousFulfillmentStubMethods) {
      const callPromise = this.asynchronousFulfillmentStub.then(
        stub => (...args: Array<{}>) => {
          if (this._terminated) {
  ...
  // -------------------
  pushFulfillmentResult(
      request: protos.google.cloud.dialogflow.v2beta1.IPushFulfillmentResultRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IFulfillmentResult,
        protos.google.cloud.dialogflow.v2beta1.IPushFulfillmentResultRequest|undefined, {}|undefined
      ]>;
  pushFulfillmentResult(
      request: protos.google.cloud.dialogflow.v2beta1.IPushFulfillmentResultRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IFulfillmentResult,
          protos.google.cloud.dialogflow.v2beta1.IPushFulfillmentResultRequest|null|undefined,
          {}|null|undefined>): void;
  pushFulfillmentResult(
      request: protos.google.cloud.dialogflow.v2beta1.IPushFulfillmentResultRequest,
      callback: Callback<
 ...
 * @param {google.cloud.dialogflow.v2beta1.FulfillmentResult} request.fulfillmentResult
 *   Required. The fulfillment result to push to Dialogflow.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [FulfillmentResult]{@link google.cloud.dialogflow.v2beta1.FulfillmentResult}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.pushFulfillmentResult(request);
 */
  pushFulfillmentResult(
      request: protos.google.cloud.dialogflow.v2beta1.IPushFulfillmentResultRequest,
    ...
    this.initialize();
    return this.innerApiCalls.pushFulfillmentResult(request, options, callback);
  }
  ...
  close(): Promise<void> {
    this.initialize();
    if (!this._terminated) {
      return this.asynchronousFulfillmentStub!.then(stub => {
