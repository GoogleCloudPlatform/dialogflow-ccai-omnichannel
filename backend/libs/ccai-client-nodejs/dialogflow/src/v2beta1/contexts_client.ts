...
export class ContextsClient {
  ...
  initialize() {
    ...
    const contextsStubMethods =
        ['listContexts', 'listContextsByConversation', 'getContext', 'getContextByConversation', 'createContext', 'createContextByConversation', 'updateContext', 'updateContextByConversation', 'deleteContext', 'deleteContextByConversation', 'deleteAllContexts', 'deleteAllContextsByConversation'];
 ...
 * {@link google.cloud.dialogflow.v2beta1.Contexts.GetContext|GetContext}. It also
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.getContextByConversation(request);
 */
  getContextByConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IGetContextRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.getContextByConversation(request, options, callback);
  }
  createContext(
 ...
 *
 * Alpha users: Please always use
 * {@link google.cloud.dialogflow.v2beta1.Contexts.CreateContext|CreateContext}. It
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.createContextByConversation(request);
 */
  createContextByConversation(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateContextRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.createContextByConversation(request, options, callback);
  }
  updateContext(
 ...
 *
 * Alpha users: Please always use
 * {@link google.cloud.dialogflow.v2beta1.Contexts.UpdateContext|UpdateContext}. It
 * also accepts names with `conversations`. This method only exists because of
 * a REST visibility issue.
 *
 * @param {Object} request
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.updateContextByConversation(request);
 */
  updateContextByConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateContextRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.updateContextByConversation(request, options, callback);
  }
  deleteContext(
 ...
 *
 * Alpha users: Please always use
 * {@link google.cloud.dialogflow.v2beta1.Contexts.DeleteContext|DeleteContext}. It
 * also accepts names with `conversations`. This method only exists because of
 * a REST visibility issue.
 *
 * @param {Object} request
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.deleteContextByConversation(request);
 */
  deleteContextByConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteContextRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.deleteContextByConversation(request, options, callback);
  }
  deleteAllContexts(
 ...
 */
  ...
  deleteAllContextsByConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAllContextsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.protobuf.IEmpty,
 ...
 *
 * Alpha users: Please always use
 * {@link google.cloud.dialogflow.v2beta1.Contexts.DeleteAllContexts|DeleteAllContexts}.
 ...
 *   for more details and examples.
 * @example
 * const [response] = await client.deleteAllContextsByConversation(request);
 */
  deleteAllContextsByConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteAllContextsRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.deleteAllContextsByConversation(request, options, callback);
  }
 ...
 *
 * Alpha users: Please always use
 * {@link google.cloud.dialogflow.v2beta1.Contexts.ListContexts|ListContexts}. It
 * also accepts names with `conversations`. This method only exists because of
 * a REST visibility issue.
 *
 * @param {Object} request
 ...
 *   times as needed and will merge results from all the pages into this array.
 *   Note that it can affect your quota.
 *   We recommend using `listContextsByConversationAsync()`
 *   method described below for async iteration which you can stop as needed.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
 *   for more details and examples.
 */
  listContextsByConversation(
    ...
    this.initialize();
    return this.innerApiCalls.listContextsByConversation(request, options, callback);
  }
 ...
 *   for more details and examples.
 */
  listContextsByConversationStream(
      request?: protos.google.cloud.dialogflow.v2beta1.IListContextsRequest,
      options?: CallOptions):
    Transform{
    request = request || {};
    ...
    const callSettings = new gax.CallSettings(options);
    this.initialize();
    return this.descriptors.page.listContextsByConversation.createStream(
      this.innerApiCalls.listContextsByConversation as gax.GaxCall,
      request,
      callSettings
    );
  }
...
/**
 * Equivalent to `listContextsByConversation`, but returns an iterable object.
 *
 * `for`-`await`-`of` syntax is used with the iterable to get response elements on-demand.
 * @param {Object} request
 *   The request object that will be sent.
 ...
 *   for more details and examples.
 * @example
 * const iterable = client.listContextsByConversationAsync(request);
 * for await (const response of iterable) {
 *   // process response
 * }
 */
  listContextsByConversationAsync(
      request?: protos.google.cloud.dialogflow.v2beta1.IListContextsRequest,
      options?: CallOptions):
    AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IContext>{
    request = request || {};
    ...
    const callSettings = new gax.CallSettings(options);
    this.initialize();
    return this.descriptors.page.listContextsByConversation.asyncIterate(
      this.innerApiCalls['listContextsByConversation'] as GaxCall,
      request as unknown as RequestType,
      callSettings
    ) as AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IContext>;
  }
