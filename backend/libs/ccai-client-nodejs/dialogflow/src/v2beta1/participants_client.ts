...
export class ParticipantsClient {
  ...
  initialize() {
    ...
    const participantsStubMethods =
        ['createParticipant', 'getParticipant', 'listParticipants', 'updateParticipant', 'analyzeContent', 'streamingAnalyzeContent', 'suggestArticles', 'suggestFaqAnswers', 'suggestSmartReplies', 'suggestSmartComposeAnswers', 'suggestDialogflowAssists', 'listSuggestions', 'compileSuggestion'];
 ...
 * @param {string} request.obfuscatedExternalUserId
 *   Obfuscated user id that should be associated with the participant. See
 *   {@link google.cloud.dialogflow.v2beta1.Participant.obfuscated_external_user_id|Participant}
 *   for details.
 * @param {object} [options]
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 ...
 */
  ...
  suggestSmartComposeAnswers(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersResponse,
        protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersRequest|undefined, {}|undefined
      ]>;
  suggestSmartComposeAnswers(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersResponse,
          protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersRequest|null|undefined,
          {}|null|undefined>): void;
  suggestSmartComposeAnswers(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [SuggestSmartComposeAnswersResponse]{@link google.cloud.dialogflow.v2beta1.SuggestSmartComposeAnswersResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.suggestSmartComposeAnswers(request);
 */
  suggestSmartComposeAnswers(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestSmartComposeAnswersRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.suggestSmartComposeAnswers(request, options, callback);
  }
  suggestDialogflowAssists(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsResponse,
        protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsRequest|undefined, {}|undefined
      ]>;
  suggestDialogflowAssists(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsResponse,
          protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsRequest|null|undefined,
          {}|null|undefined>): void;
  suggestDialogflowAssists(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [SuggestDialogflowAssistsResponse]{@link google.cloud.dialogflow.v2beta1.SuggestDialogflowAssistsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.suggestDialogflowAssists(request);
 */
  suggestDialogflowAssists(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestDialogflowAssistsRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.suggestDialogflowAssists(request, options, callback);
  }
  compileSuggestion(
