...
export class ConversationsClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.page = {
      ...
      listCallMatchers:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'callMatchers'),
      listMessages:
    ...
    const exportMessagesResponse = protoFilesRoot.lookup(
      '.google.cloud.dialogflow.v2beta1.ExportMessagesResponse') as gax.protobuf.Type;
    const exportMessagesMetadata = protoFilesRoot.lookup(
      '.google.protobuf.Struct') as gax.protobuf.Type;

    this.descriptors.longrunning = {
      exportMessages: new this._gaxModule.LongrunningDescriptor(
        this.operationsClient,
        exportMessagesResponse.decode.bind(exportMessagesResponse),
        exportMessagesMetadata.decode.bind(exportMessagesMetadata))
    };
  ...
  initialize() {
    ...
    const conversationsStubMethods =
        ['createConversation', 'listConversations', 'getConversation', 'addConversationPhoneNumber', 'completeConversation', 'updateConversation', 'createCallMatcher', 'listCallMatchers', 'deleteCallMatcher', 'batchCreateMessages', 'listMessages', 'exportMessages', 'suggestConversationSummary', 'suggestConversationKeyMoments'];
 ...
 */
  ...
  addConversationPhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IAddConversationPhoneNumberRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IConversationPhoneNumber,
        protos.google.cloud.dialogflow.v2beta1.IAddConversationPhoneNumberRequest|undefined, {}|undefined
      ]>;
  addConversationPhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IAddConversationPhoneNumberRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IConversationPhoneNumber,
          protos.google.cloud.dialogflow.v2beta1.IAddConversationPhoneNumberRequest|null|undefined,
          {}|null|undefined>): void;
  addConversationPhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IAddConversationPhoneNumberRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [ConversationPhoneNumber]{@link google.cloud.dialogflow.v2beta1.ConversationPhoneNumber}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.addConversationPhoneNumber(request);
 */
  addConversationPhoneNumber(
      request: protos.google.cloud.dialogflow.v2beta1.IAddConversationPhoneNumberRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.addConversationPhoneNumber(request, options, callback);
  }
 ...
 */
  ...
  updateConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateConversationRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.IConversation,
        protos.google.cloud.dialogflow.v2beta1.IUpdateConversationRequest|undefined, {}|undefined
      ]>;
  updateConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateConversationRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.IConversation,
          protos.google.cloud.dialogflow.v2beta1.IUpdateConversationRequest|null|undefined,
          {}|null|undefined>): void;
  updateConversation(
      request: protos.google.cloud.dialogflow.v2beta1.IUpdateConversationRequest,
      callback: Callback<
 ...
 */
  ...
  createCallMatcher(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest|undefined, {}|undefined
      ]>;
  createCallMatcher(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.ICallMatcher,
          protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest|null|undefined,
          {}|null|undefined>): void;
  createCallMatcher(
      request: protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest,
      callback: Callback<
 ...
 */
  ...
  deleteCallMatcher(
      ...
      Promise<[
        ...
        protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest|undefined, {}|undefined
      ]>;
  deleteCallMatcher(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.protobuf.IEmpty,
          protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest|null|undefined,
          {}|null|undefined>): void;
  deleteCallMatcher(
      request: protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest,
      callback: Callback<
 ...
 *   {@link google.cloud.dialogflow.v2beta1.CallMatcher|CallMatcher} to delete.
 *   Format: `projects/<Project ID>/locations/<Location
 ...
 */
  ...
  suggestConversationKeyMoments(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsRequest,
      options?: CallOptions):
      Promise<[
        protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsResponse,
        protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsRequest|undefined, {}|undefined
      ]>;
  suggestConversationKeyMoments(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsResponse,
          protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsRequest|null|undefined,
          {}|null|undefined>): void;
  suggestConversationKeyMoments(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [SuggestConversationKeyMomentsResponse]{@link google.cloud.dialogflow.v2beta1.SuggestConversationKeyMomentsResponse}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
 * const [response] = await client.suggestConversationKeyMoments(request);
 */
  suggestConversationKeyMoments(
      request: protos.google.cloud.dialogflow.v2beta1.ISuggestConversationKeyMomentsRequest,
      optionsOrCallback?: CallOptions|Callback<
    ...
    this.initialize();
    return this.innerApiCalls.suggestConversationKeyMoments(request, options, callback);
  }

  exportMessages(
      request: protos.google.cloud.dialogflow.v2beta1.IExportMessagesRequest,
      options?: CallOptions):
      Promise<[
        LROperation<protos.google.cloud.dialogflow.v2beta1.IExportMessagesResponse, protos.google.protobuf.IStruct>,
 ...
 * @param {google.cloud.dialogflow.v2beta1.GcsDestination} request.gcsDestination
 ...
 *   for more details and examples.
 * @example
 * const [operation] = await client.exportMessages(request);
 ...
 */
  exportMessages(
    ...
    this.initialize();
    return this.innerApiCalls.exportMessages(request, options, callback);
  }
/**
 * Check the status of the long running operation returned by `exportMessages()`.
 * @param {String} name
 ...
 *   for more details and examples.
 * @example
 * const decodedOperation = await checkExportMessagesProgress(name);
 * console.log(decodedOperation.result);
 * console.log(decodedOperation.done);
 * console.log(decodedOperation.metadata);
 */
  async checkExportMessagesProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.ExportMessagesResponse, protos.google.protobuf.Struct>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.exportMessages, gax.createDefaultBackoffSettings());
    return decodeOperation as LROperation<protos.google.cloud.dialogflow.v2beta1.ExportMessagesResponse, protos.google.protobuf.Struct>;
  }
  listConversations(
 ...
 */
  ...
  listCallMatchers(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.dialogflow.v2beta1.IListCallMatchersResponse|null|undefined,
          protos.google.cloud.dialogflow.v2beta1.ICallMatcher>): void;
  listCallMatchers(
      request: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest,
      callback: PaginationCallback<
          protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest,
