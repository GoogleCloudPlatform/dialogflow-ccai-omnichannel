...
const PhoneNumberOrdersClient = v2.PhoneNumberOrdersClient;
type PhoneNumberOrdersClient = v2.PhoneNumberOrdersClient;
const PhoneNumbersClient = v2.PhoneNumbersClient;
type PhoneNumbersClient = v2.PhoneNumbersClient;
...
export {v2, AgentsClient, AnswerRecordsClient, ContextsClient, ConversationProfilesClient, ConversationsClient, DocumentsClient, EntityTypesClient, EnvironmentsClient, FulfillmentsClient, IntentsClient, KnowledgeBasesClient, ParticipantsClient, PhoneNumberOrdersClient, PhoneNumbersClient, SessionEntityTypesClient, SessionsClient, VersionsClient};
export default {v2, AgentsClient, AnswerRecordsClient, ContextsClient, ConversationProfilesClient, ConversationsClient, DocumentsClient, EntityTypesClient, EnvironmentsClient, FulfillmentsClient, IntentsClient, KnowledgeBasesClient, ParticipantsClient, PhoneNumberOrdersClient, PhoneNumbersClient, SessionEntityTypesClient, SessionsClient, VersionsClient};
import * as protos from '../protos/protos';
export {protos}
import * as v2beta1 from './v2beta1';export {v2beta1};