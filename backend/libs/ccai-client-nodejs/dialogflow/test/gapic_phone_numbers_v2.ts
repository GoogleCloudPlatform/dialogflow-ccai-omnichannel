...
describe('v2.PhoneNumbersClient', () => {
    it('has servicePath', () => {
        const servicePath = phonenumbersModule.v2.PhoneNumbersClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = phonenumbersModule.v2.PhoneNumbersClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = phonenumbersModule.v2.PhoneNumbersClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new phonenumbersModule.v2.PhoneNumbersClient();
        assert(client);
    });
    ...
    describe('updatePhoneNumber', () => {
        it('invokes updatePhoneNumber without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.UpdatePhoneNumberRequest());
            request.phoneNumber = {};
            request.phoneNumber.name = '';
            const expectedHeaderRequestParams = "phone_number.name=";
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumber());
        ...
        it('invokes updatePhoneNumber without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.updatePhoneNumber(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IPhoneNumber|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('deletePhoneNumber', () => {
        it('invokes deletePhoneNumber without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.DeletePhoneNumberRequest());
            request.name = '';
    ...
    describe('undeletePhoneNumber', () => {
        it('invokes undeletePhoneNumber without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.UndeletePhoneNumberRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.undeletePhoneNumber as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listPhoneNumbers', () => {
        it('invokes listPhoneNumbers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ListPhoneNumbersRequest());
            request.parent = '';
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumber()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumber()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumber()),
            ];
        ...
        it('invokes listPhoneNumbersStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.PhoneNumber[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.PhoneNumber) => {
        ...
        it('uses async iteration with listPhoneNumbers without error', async () => {
            ...
            const responses: protos.google.cloud.dialogflow.v2.IPhoneNumber[] = [];
