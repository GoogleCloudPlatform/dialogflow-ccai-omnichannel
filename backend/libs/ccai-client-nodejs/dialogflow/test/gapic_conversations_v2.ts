...
describe('v2.ConversationsClient', () => {
    ...
    describe('createConversation', () => {
        it('invokes createConversation without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.Conversation());
    ...
    describe('addConversationPhoneNumber', () => {
        it('invokes addConversationPhoneNumber without error', async () => {
            const client = new conversationsModule.v2.ConversationsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.AddConversationPhoneNumberRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationPhoneNumber());
            client.innerApiCalls.addConversationPhoneNumber = stubSimpleCall(expectedResponse);
            const [response] = await client.addConversationPhoneNumber(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.addConversationPhoneNumber as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes addConversationPhoneNumber without error using callback', async () => {
            const client = new conversationsModule.v2.ConversationsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ConversationPhoneNumber());
            client.innerApiCalls.addConversationPhoneNumber = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.addConversationPhoneNumber(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IConversationPhoneNumber|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes addConversationPhoneNumber with error', async () => {
            const client = new conversationsModule.v2.ConversationsClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.addConversationPhoneNumber = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.addConversationPhoneNumber(request), expectedError);
            assert((client.innerApiCalls.addConversationPhoneNumber as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createCallMatcher', () => {
        it('invokes createCallMatcher without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.CreateCallMatcherRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.CallMatcher());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createCallMatcher as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createCallMatcher without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.CallMatcher());
            client.innerApiCalls.createCallMatcher = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createCallMatcher(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.ICallMatcher|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createCallMatcher with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.createCallMatcher = stubSimpleCall(undefined, expectedError);
    ...
    describe('deleteCallMatcher', () => {
        it('invokes deleteCallMatcher without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.DeleteCallMatcherRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteCallMatcher as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes deleteCallMatcher without error using callback', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.deleteCallMatcher = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deleteCallMatcher with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deleteCallMatcher = stubSimpleCall(undefined, expectedError);
    ...
    describe('listCallMatchers', () => {
        it('invokes listCallMatchers without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ListCallMatchersRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.CallMatcher()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.CallMatcher()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.CallMatcher()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listCallMatchers as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listCallMatchers without error using callback', async () => {
            ...
            client.innerApiCalls.listCallMatchers = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes listCallMatchers with error', async () => {
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listCallMatchers = stubSimpleCall(undefined, expectedError);
        ...
        it('invokes listCallMatchersStream without error', async () => {
            ...
            client.descriptors.page.listCallMatchers.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listCallMatchersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.CallMatcher[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.CallMatcher) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert((client.descriptors.page.listCallMatchers.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listCallMatchers, request));
            assert.strictEqual(
        ...
        it('invokes listCallMatchersStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listCallMatchers.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listCallMatchersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.CallMatcher[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.CallMatcher) => {
        ...
        it('uses async iteration with listCallMatchers without error', async () => {
            ...
            client.descriptors.page.listCallMatchers.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(
                (client.descriptors.page.listCallMatchers.asyncIterate as SinonStub)
                    .getCall(0).args[1], request);
            assert.strictEqual(
                (client.descriptors.page.listCallMatchers.asyncIterate as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
        ...
        it('uses async iteration with listCallMatchers with error', async () => {
            ...
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";const expectedError = new Error('expected');
            client.descriptors.page.listCallMatchers.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listCallMatchersAsync(request);
            await assert.rejects(async () => {
                const responses: protos.google.cloud.dialogflow.v2.ICallMatcher[] = [];
                for await (const resource of iterable) {
