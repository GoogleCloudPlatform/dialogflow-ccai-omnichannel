...
import * as phonenumberordersModule from '../src';
...
describe('v2.PhoneNumberOrdersClient', () => {
    it('has servicePath', () => {
        const servicePath = phonenumberordersModule.v2.PhoneNumberOrdersClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = phonenumberordersModule.v2.PhoneNumberOrdersClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = phonenumberordersModule.v2.PhoneNumberOrdersClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient();
        assert(client);
    });
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.phoneNumberOrdersStub, undefined);
        await client.initialize();
        assert(client.phoneNumberOrdersStub);
    });
    ...
    describe('createPhoneNumberOrder', () => {
        it('invokes createPhoneNumberOrder without error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.CreatePhoneNumberOrderRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder());
            client.innerApiCalls.createPhoneNumberOrder = stubSimpleCall(expectedResponse);
            const [response] = await client.createPhoneNumberOrder(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createPhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes createPhoneNumberOrder without error using callback', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder());
            client.innerApiCalls.createPhoneNumberOrder = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.createPhoneNumberOrder(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IPhoneNumberOrder|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createPhoneNumberOrder with error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createPhoneNumberOrder = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.createPhoneNumberOrder(request), expectedError);
            assert((client.innerApiCalls.createPhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('getPhoneNumberOrder', () => {
        it('invokes getPhoneNumberOrder without error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.GetPhoneNumberOrderRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder());
            client.innerApiCalls.getPhoneNumberOrder = stubSimpleCall(expectedResponse);
            const [response] = await client.getPhoneNumberOrder(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getPhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes getPhoneNumberOrder without error using callback', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder());
            client.innerApiCalls.getPhoneNumberOrder = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.getPhoneNumberOrder(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IPhoneNumberOrder|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes getPhoneNumberOrder with error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.getPhoneNumberOrder = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.getPhoneNumberOrder(request), expectedError);
            assert((client.innerApiCalls.getPhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('updatePhoneNumberOrder', () => {
        it('invokes updatePhoneNumberOrder without error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.UpdatePhoneNumberOrderRequest());
            request.phoneNumberOrder = {};
            request.phoneNumberOrder.name = '';
            const expectedHeaderRequestParams = "phone_number_order.name=";
            const expectedOptions = {
                otherArgs: {
                    headers: {
                        'x-goog-request-params': expectedHeaderRequestParams,
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder());
            client.innerApiCalls.updatePhoneNumberOrder = stubSimpleCall(expectedResponse);
            const [response] = await client.updatePhoneNumberOrder(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updatePhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes updatePhoneNumberOrder without error using callback', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder());
            client.innerApiCalls.updatePhoneNumberOrder = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.updatePhoneNumberOrder(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IPhoneNumberOrder|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes updatePhoneNumberOrder with error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.updatePhoneNumberOrder = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.updatePhoneNumberOrder(request), expectedError);
            assert((client.innerApiCalls.updatePhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('cancelPhoneNumberOrder', () => {
        it('invokes cancelPhoneNumberOrder without error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.CancelPhoneNumberOrderRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            client.innerApiCalls.cancelPhoneNumberOrder = stubSimpleCall(expectedResponse);
            const [response] = await client.cancelPhoneNumberOrder(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.cancelPhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes cancelPhoneNumberOrder without error using callback', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.cancelPhoneNumberOrder = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.cancelPhoneNumberOrder(
                    request,
        ...
        it('invokes cancelPhoneNumberOrder with error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.cancelPhoneNumberOrder = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.cancelPhoneNumberOrder(request), expectedError);
            assert((client.innerApiCalls.cancelPhoneNumberOrder as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });

    describe('listPhoneNumberOrders', () => {
        it('invokes listPhoneNumberOrders without error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ListPhoneNumberOrdersRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder()),
              generateSampleMessage(new protos.google.cloud.dialogflow.v2.PhoneNumberOrder()),
            ];
            client.innerApiCalls.listPhoneNumberOrders = stubSimpleCall(expectedResponse);
            const [response] = await client.listPhoneNumberOrders(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listPhoneNumberOrders as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listPhoneNumberOrders without error using callback', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listPhoneNumberOrders = stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.listPhoneNumberOrders(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.dialogflow.v2.IPhoneNumberOrder[]|null) => {
                        if (err) {
                            reject(err);
        ...
        it('invokes listPhoneNumberOrders with error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.listPhoneNumberOrders = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.listPhoneNumberOrders(request), expectedError);
            assert((client.innerApiCalls.listPhoneNumberOrders as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes listPhoneNumberOrdersStream without error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listPhoneNumberOrders.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.listPhoneNumberOrdersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.PhoneNumberOrder[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.PhoneNumberOrder) => {
            ...
            assert((client.descriptors.page.listPhoneNumberOrders.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.listPhoneNumberOrders, request));
            assert.strictEqual(
                (client.descriptors.page.listPhoneNumberOrders.createStream as SinonStub)
                    .getCall(0).args[2].otherArgs.headers['x-goog-request-params'],
                expectedHeaderRequestParams
            );
        });

        it('invokes listPhoneNumberOrdersStream with error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            const expectedHeaderRequestParams = "parent=";
            const expectedError = new Error('expected');
            client.descriptors.page.listPhoneNumberOrders.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.listPhoneNumberOrdersStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.dialogflow.v2.PhoneNumberOrder[] = [];
                stream.on('data', (response: protos.google.cloud.dialogflow.v2.PhoneNumberOrder) => {
        ...
        it('uses async iteration with listPhoneNumberOrders without error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listPhoneNumberOrders.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: protos.google.cloud.dialogflow.v2.IPhoneNumberOrder[] = [];
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.listPhoneNumberOrders.asyncIterate as SinonStub)
        ...
        it('uses async iteration with listPhoneNumberOrders with error', async () => {
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            });
            ...
            client.descriptors.page.listPhoneNumberOrders.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.listPhoneNumberOrdersAsync(request);
    ...
    describe('Path templates', () => {
        ...
        describe('projectLocationPhoneNumberOrder', () => {
            const fakePath = "/rendered/path/projectLocationPhoneNumberOrder";
            const expectedParameters = {
                project: "projectValue",
                location: "locationValue",
                phone_number_order: "phoneNumberOrderValue",
            };
            const client = new phonenumberordersModule.v2.PhoneNumberOrdersClient({
                credentials: {client_email: 'bogus', private_key: 'bogus'},
                projectId: 'bogus',
            ...
            client.initialize();
            client.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectLocationPhoneNumberOrderPath', () => {
                const result = client.projectLocationPhoneNumberOrderPath("projectValue", "locationValue", "phoneNumberOrderValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectLocationPhoneNumberOrderName', () => {
                const result = client.matchProjectFromProjectLocationPhoneNumberOrderName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchLocationFromProjectLocationPhoneNumberOrderName', () => {
                const result = client.matchLocationFromProjectLocationPhoneNumberOrderName(fakePath);
                assert.strictEqual(result, "locationValue");
                assert((client.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchPhoneNumberOrderFromProjectLocationPhoneNumberOrderName', () => {
                const result = client.matchPhoneNumberOrderFromProjectLocationPhoneNumberOrderName(fakePath);
                assert.strictEqual(result, "phoneNumberOrderValue");
                assert((client.pathTemplates.projectLocationPhoneNumberOrderPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
        });
        ...
        describe('projectPhoneNumberOrder', () => {
            const fakePath = "/rendered/path/projectPhoneNumberOrder";
            const expectedParameters = {
                project: "projectValue",
                phone_number_order: "phoneNumberOrderValue",
            };
            ...
            client.initialize();
            client.pathTemplates.projectPhoneNumberOrderPathTemplate.render =
                sinon.stub().returns(fakePath);
            client.pathTemplates.projectPhoneNumberOrderPathTemplate.match =
                sinon.stub().returns(expectedParameters);

            it('projectPhoneNumberOrderPath', () => {
                const result = client.projectPhoneNumberOrderPath("projectValue", "phoneNumberOrderValue");
                assert.strictEqual(result, fakePath);
                assert((client.pathTemplates.projectPhoneNumberOrderPathTemplate.render as SinonStub)
                    .getCall(-1).calledWith(expectedParameters));
            });

            it('matchProjectFromProjectPhoneNumberOrderName', () => {
                const result = client.matchProjectFromProjectPhoneNumberOrderName(fakePath);
                assert.strictEqual(result, "projectValue");
                assert((client.pathTemplates.projectPhoneNumberOrderPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });

            it('matchPhoneNumberOrderFromProjectPhoneNumberOrderName', () => {
                const result = client.matchPhoneNumberOrderFromProjectPhoneNumberOrderName(fakePath);
                assert.strictEqual(result, "phoneNumberOrderValue");
                assert((client.pathTemplates.projectPhoneNumberOrderPathTemplate.match as SinonStub)
                    .getCall(-1).calledWith(fakePath));
            });
