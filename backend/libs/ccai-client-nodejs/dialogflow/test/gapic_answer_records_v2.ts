...
describe('v2.AnswerRecordsClient', () => {
    ...
    describe('updateAnswerRecord', () => {
        it('invokes updateAnswerRecord without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.UpdateAnswerRecordRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.dialogflow.v2.AnswerRecord());
            ...
            assert((client.innerApiCalls.updateAnswerRecord as SinonStub)
    ...
    describe('listAnswerRecords', () => {
        it('invokes listAnswerRecords without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.dialogflow.v2.ListAnswerRecordsRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAnswerRecords as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
