...
function doStuffWithPhoneNumberOrdersClient(client: PhoneNumberOrdersClient) {
  client.close();
}
...
function main() {
  ...
  // check that the client instance can be created
  const phoneNumberOrdersClient = new PhoneNumberOrdersClient();
  doStuffWithPhoneNumberOrdersClient(phoneNumberOrdersClient);
  // check that the client instance can be created
